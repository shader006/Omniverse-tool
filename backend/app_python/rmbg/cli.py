#!/usr/bin/env python3
"""
CLI interface for Background Removal powered by BiRefNet-Lite & Intel OpenVINO.
...
def main():
    parser = argparse.ArgumentParser(description="CLI Tool for BiRefNet-Lite Background Removal")
